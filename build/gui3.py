...
class BancoApp:
    ...
    #imagem usuário cinza 
     imagem_usuario = Image.open(r"build\assets\frame3\do-utilizador.png")
    ...
    #logo banco invertida
     imagem_logo = Image.open(r"build\assets\frame3\logo banco invert.png")
    ...
    def create_login_widgets(self):
        ...
        self.frame1 = tk.Frame(self.root, bg='#FFFAFA', width=700 ,height=1080)
        self.frame1.place(relx=0.03, rely=0.5, anchor='w')
        
        self.label_bemvindo = tk.Label(text="Faça seu login", font=('SourceSansPro-Bold', 40, 'bold'), bg="#FFFAFA", fg="#4270A8")
        self.label_bemvindo.place(x=150, y=70) #correto

        self.label_titular_login = tk.Label(self.frame1, text="CPF:", font=('SourceSansPro-Bold', 24, 'bold'), bg='#FFFAFA')
        self.label_titular_login.place(x=50, y=450)

        self.entry_titular_login = tk.Entry(self.frame1, font=('SourceSansPro-Bold', 20, 'bold'), bg='#c6d1e1', fg='#000000', width=25)
        self.entry_titular_login.place(x=55, y=500)

        self.label_senha_login = tk.Label(self.frame1, text="Senha:", bg='#FFFAFA', font=('SourceSansPro-Bold', 24, 'bold'))
        self.label_senha_login.place(x=50, y=600)

        self.entry_senha_login = tk.Entry(self.frame1, show="*", font=('SourceSansPro-Bold', 20, 'bold'), width=25, bg='#c6d1e1', fg='#000000')
        self.entry_senha_login.place(x=55, y=650)

        self.button_login = tk.Button(text="Login", command=self.login, font=('SourceSansPro-Bold', 20, 'bold'), bg='#4270A8', fg='#FFFAFA',width=10)
        self.button_login.place(x=200, y=800)

        self.framelogin = tk.Frame(self.root, bd=4, bg='#4270A8', highlightbackground='#4270A8', highlightthickness=3)
        self.framelogin.place(relx=0.35, rely=0, relwidth=10, relheight=10)

        self.label_cadastro = tk.Label(self.frame1,text="Não tem cadastro ainda? Clique aqui!", font=('SourceSansPro-Bold', 12, 'bold'),bg="#FFFAFA",fg='#4270A8')
        self.label_cadastro.place(x=50, y=700)
        ...
        #somente imagens
        self.label_imagem = tk.Label(self.frame1, image=self.img1, bg='#FFFAFA' )
        self.label_imagem.place(relx=0.22, rely=0.2, anchor='nw')
